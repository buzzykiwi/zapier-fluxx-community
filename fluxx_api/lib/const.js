...
[
	...
	{op:"IS IN YEAR RANGE (\\d+/\\d+/\\d+ *- *\\d+/\\d+/\\d+)", fluxx_op:"range-year-cal", use_second_capture:true},
	{op:"IS IN FISCAL YEAR RANGE (\\d+/\\d+/\\d+ *- *\\d+/\\d+/\\d+)", fluxx_op:"range-year-fiscal", use_second_capture:true},
